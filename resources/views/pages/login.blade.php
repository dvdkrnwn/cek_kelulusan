...
<head>
    ...
    <title>Dashboard - Cek Kelulusan Mahasiswa</title>
                        ...
                        <div class="app-brand justify-content-center">
                            <a class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img width="35" src="{{ asset('sneat') }}/assets/img/logo.png">
                                </span>
                                <span class="app-brand-text demo text-body fw-bolder">Vokasi UB</span>
                            </a>
                        </div>
                        <!-- /Logo -->
